...
public class SerialPortConnectionTester extends javax.swing.JFrame implements SerialPortEventListener {
  ...
  public SerialPortConnectionTester() {
    try {
      UIManager.setLookAndFeel("com.sun.java.swing.plaf.windows.WindowsLookAndFeel");
    } catch (ClassNotFoundException ex) {
      Logger.getLogger(SerialPortConnectionTester.class.getName()).log(Level.SEVERE, null, ex);
    ...
    this.displayHex.setSelected(true);
    sendCR = true;
    sendLF = false;
...
//      }
  ...
  public static void main(String args[]) {
    java.awt.EventQueue.invokeLater(new Runnable() {
      ...
      public void run() {
        new SerialPortConnectionTester().setVisible(true);
      }
    });
  }
