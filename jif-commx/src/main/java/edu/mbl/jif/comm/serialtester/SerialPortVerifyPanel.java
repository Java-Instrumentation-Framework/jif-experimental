...
public class SerialPortVerifyPanel
    extends JPanel
  ...
  private void jbInit() throws Exception {
    image1 = new ImageIcon(edu.mbl.jif.comm.serialtester.SerialPortVerifyPanel.class.getResource(
        "openFile.gif"));
    image2 = new ImageIcon(edu.mbl.jif.comm.serialtester.SerialPortVerifyPanel.class.getResource(
        "celogoicon32.gif"));
    image3 = new ImageIcon(edu.mbl.jif.comm.serialtester.SerialPortVerifyPanel.class.getResource(
        "help.gif"));
    //setIconImage(Toolkit.getDefaultToolkit().createImage(SerialPortVerifyPanel.class.getResource("[Your Icon]")));
    ...
    jMenuFileOpen.addActionListener(new
                                    SerialPortVerifyPanel_jMenuFileOpen_actionAdapter(this));
    ...
    SendCommandButton.addActionListener(new
                                        SerialPortVerifyPanel_SendCommandButton_actionAdapter(this));
    ...
    ResponseAsASCIICheckBox.addItemListener(new
                                            SerialPortVerifyPanel_ResponseAsASCIICheckBox_itemAdapter(this));
    ...
    CommandComboBox.addActionListener(new
                                      SerialPortVerifyPanel_CommandComboBox_actionAdapter(this));
    ...
    BaudComboBox1.addActionListener(new
                                    SerialPortVerifyPanel_BaudComboBox1_actionAdapter(this));
    DataBitsComboBox1.addActionListener(new
                                        SerialPortVerifyPanel_DataBitsComboBox1_actionAdapter(this));
    StopBitsComboBox1.addActionListener(new
                                        SerialPortVerifyPanel_StopBitsComboBox1_actionAdapter(this));
    jPanel2.setLayout(gridBagLayout7);
    TestButton.setEnabled(false);
    TestButton.setText("Start Test");
    TestButton.addActionListener(new
                                 SerialPortVerifyPanel_TestButton_actionAdapter(this));
    ...
    jButtonFileOpen1.addActionListener(new
                                       SerialPortVerifyPanel_jButtonFileOpen1_actionAdapter(this));
    ...
    CommandAsASCIICheckBox.addItemListener(new
                                           SerialPortVerifyPanel_CommandAsASCIICheckBox_itemAdapter(this));
    ...
    this.add(BaudComboBox1,
                          new GridBagConstraints(1, 1, 1, 1, 1.0, 0.0
                                                 , GridBagConstraints.CENTER,
                                                 GridBagConstraints.HORIZONTAL,
                                                 new Insets(0, 8, 0, 0), 26, 1));
    this.add(DataBitsComboBox1,
                          new GridBagConstraints(2, 1, 1, 1, 1.0, 0.0
                                                 , GridBagConstraints.CENTER,
                                                 GridBagConstraints.HORIZONTAL,
                                                 new Insets(0, 8, 0, 9), 15, 1));
    this.add(jLabel4, new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0
        , GridBagConstraints.WEST,
        GridBagConstraints.NONE,
        new Insets(4, 0, 0, 0), 8, 0));
    this.add(StopBitsComboBox1,
    ...
    this.add(BreakDurationTextField,
                          new GridBagConstraints(7, 1, 1, 1, 1.0, 0.0
                                                 , GridBagConstraints.WEST,
                                                 GridBagConstraints.HORIZONTAL,
                                                 new Insets(0, 23, 0, 3), 35, 1));
    this.add(jLabel15, new GridBagConstraints(4, 0, 3, 1, 0.0, 0.0
        , GridBagConstraints.WEST,
        GridBagConstraints.NONE,
        new Insets(4, 19, 0, 9), 23, 0));
    this.add(jLabel16, new GridBagConstraints(7, 0, 1, 1, 0.0, 0.0
        , GridBagConstraints.WEST,
        GridBagConstraints.NONE,
...
//calculate the time to send
  ...
  class SerialPortVerifyPanel_jMenuFileExit_ActionAdapter
      implements ActionListener {
    private SerialPortVerifyPanel adaptee;

    SerialPortVerifyPanel_jMenuFileExit_ActionAdapter(SerialPortVerifyPanel
        adaptee) {
  ...
  class SerialPortVerifyPanel_jButtonFileOpen_actionAdapter
      implements java.awt.event.ActionListener {
    private SerialPortVerifyPanel adaptee;

    SerialPortVerifyPanel_jButtonFileOpen_actionAdapter(SerialPortVerifyPanel
        adaptee) {
      this.adaptee = adaptee;
    }
  ...
  class SerialPortVerifyPanel_jMenuFileOpen_actionAdapter
      implements java.awt.event.ActionListener {
    private SerialPortVerifyPanel adaptee;

    SerialPortVerifyPanel_jMenuFileOpen_actionAdapter(SerialPortVerifyPanel
        adaptee) {
      this.adaptee = adaptee;
    }
  ...
  class SerialPortVerifyPanel_jButtonFileOpen1_actionAdapter
      implements java.awt.event.ActionListener {
    private SerialPortVerifyPanel adaptee;

    SerialPortVerifyPanel_jButtonFileOpen1_actionAdapter(SerialPortVerifyPanel
        adaptee) {
      this.adaptee = adaptee;
    }
  ...
  class SerialPortVerifyPanel_TestButton_actionAdapter
      implements java.awt.event.ActionListener {
    private SerialPortVerifyPanel adaptee;

    SerialPortVerifyPanel_TestButton_actionAdapter(SerialPortVerifyPanel
        adaptee) {
      this.adaptee = adaptee;
    }
...
//        HexString hexs = new HexString();
//        String sss = hexs.toHexString((byte[])c);
//        String current = hexs.toHexFormattedString("this");
//        _commandTester.StartTest("");
      }
      else {
...
//----------------------------------------------------------------------------
class SerialPortVerifyPanel_CommandComboBox_actionAdapter
    implements java.awt.event.ActionListener {
  private SerialPortVerifyPanel adaptee;

  SerialPortVerifyPanel_CommandComboBox_actionAdapter(SerialPortVerifyPanel
      adaptee) {
    this.adaptee = adaptee;
  }
...
class SerialPortVerifyPanel_SendCommandButton_actionAdapter
    implements java.awt.event.ActionListener {
  private SerialPortVerifyPanel adaptee;

  SerialPortVerifyPanel_SendCommandButton_actionAdapter(SerialPortVerifyPanel
      adaptee) {
    this.adaptee = adaptee;
  }
...
class SerialPortVerifyPanel_BaudComboBox1_actionAdapter
    implements java.awt.event.ActionListener {
  private SerialPortVerifyPanel adaptee;

  SerialPortVerifyPanel_BaudComboBox1_actionAdapter(SerialPortVerifyPanel
      adaptee) {
    this.adaptee = adaptee;
  }
...
class SerialPortVerifyPanel_DataBitsComboBox1_actionAdapter
    implements java.awt.event.ActionListener {
  private SerialPortVerifyPanel adaptee;

  SerialPortVerifyPanel_DataBitsComboBox1_actionAdapter(SerialPortVerifyPanel
      adaptee) {
    this.adaptee = adaptee;
  }
...
class SerialPortVerifyPanel_StopBitsComboBox1_actionAdapter
    implements java.awt.event.ActionListener {
  private SerialPortVerifyPanel adaptee;

  SerialPortVerifyPanel_StopBitsComboBox1_actionAdapter(SerialPortVerifyPanel
      adaptee) {
    this.adaptee = adaptee;
  }
...
class SerialPortVerifyPanel_ResponseAsASCIICheckBox_itemAdapter
    implements java.awt.event.ItemListener {
  private SerialPortVerifyPanel adaptee;

  SerialPortVerifyPanel_ResponseAsASCIICheckBox_itemAdapter(
      SerialPortVerifyPanel adaptee) {
    this.adaptee = adaptee;
  }
...
class SerialPortVerifyPanel_CommandAsASCIICheckBox_itemAdapter
    implements java.awt.event.ItemListener {
  SerialPortVerifyPanel adaptee;

  SerialPortVerifyPanel_CommandAsASCIICheckBox_itemAdapter(
      SerialPortVerifyPanel adaptee) {
    this.adaptee = adaptee;
  }
...
class SerialPortVerifyPanel_checkBox_CR_itemAdapter
    implements java.awt.event.ItemListener {
  SerialPortVerifyPanel adaptee;

  SerialPortVerifyPanel_checkBox_CR_itemAdapter(SerialPortVerifyPanel adaptee) {
    this.adaptee = adaptee;
  }
...
class SerialPortVerifyPanel_checkBox_LF_itemAdapter
    implements java.awt.event.ItemListener {
  SerialPortVerifyPanel adaptee;

  SerialPortVerifyPanel_checkBox_LF_itemAdapter(SerialPortVerifyPanel adaptee) {
    this.adaptee = adaptee;
  }
