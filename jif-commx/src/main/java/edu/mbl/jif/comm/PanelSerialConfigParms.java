 ...
 * @version 1.0
 */
public class PanelSerialConfigParms
  ...
  public PanelSerialConfigParms() {
    this(new SerialPortConnection());
  }

  public PanelSerialConfigParms(SerialPortConnection connection) {
