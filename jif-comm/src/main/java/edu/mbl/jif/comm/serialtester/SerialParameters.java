...
public class SerialParameters {
    ...
    private class SerialProperties extends Properties {
      SerialProperties() {
        init();
        try {
          FileInputStream fis = new FileInputStream("serialverifier.properties");
          load(fis);
          fis.close();
      ...
      public void store() throws IOException {
        ...
        fileOut = new FileOutputStream("serialverifier.properties");
        super.store(fileOut, "Serial Demo poperties");
        fileOut.close();
      }
    }
