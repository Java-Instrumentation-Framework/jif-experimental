...
public class JXInputDevicePanel extends javax.swing.JPanel {
    ...
    private class AxisSlider extends JSlider {
        ...
        AxisSlider( Axis axis ) {
            super( ( Axis.SLIDER == axis.getType() ? 0 : -100000 ), 100000 );
            this.setMajorTickSpacing( Axis.SLIDER == axis.getType() ? 1000 : 5000 );
        ...
        void update() {
            ...
            //System.out.println("AxisUpdate: " + mAxis.getName() + " = " + mAxis.getValue());
            //
