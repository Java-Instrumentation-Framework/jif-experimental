...
/** Data generated by a PolledDeviceDI. 
...
public class PolledDeviceDIData implements PolledDeviceData {

    /** The device which generated this data. */
    private PolledDeviceDI source;

    /** The index of the first button which has changed its state
        since the last polling cycle. Is (-1) if no button has changed
        its state. */
    ...
    /** The index of the first directional which has changed its state
        since the last polling cycle. Is (-1) if no directional has changed
        its state. */
	...
	@param s the device which generated the data. 
	@param cbi the index of the button which has changed its state at the last polling cycle.
	@param b the array of button states.
	@param cdi the index of the directional which has changed its state at the last polling cycle.
	@param ds the array of directional states.
	@param d the array of direction values.
	@param a the array of axis values.
	@param t the time in nanoseconds when the last polling cycle was finished. */
    public PolledDeviceDIData(PolledDeviceDI s, int cbi, boolean[] b, int cdi, boolean[] ds, int[] d, double[] a, long t) {
	source = s;
    ...
    public PolledDeviceDI getSource() {
	return source;
    }


    /** Get the index of the first button which has changed its state
        since the last polling cycle. Is (-1) if no button has changed
        its state. */
    ...
    /** Get the index of the first directional which has changed its
        state since the last polling cycle. Is (-1) if no directional
