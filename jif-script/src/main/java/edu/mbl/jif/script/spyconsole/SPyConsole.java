      ...
      extends InteractiveConsole
{
   ...
   public SPyConsole () {
      ...
      _inputAction = new StyledEditorKit.ForegroundAction("start input",
            Color.black);
   ...
   void addStyles () {
      ...
      _styles.addDerived("prompt", basic, Color.gray);
   }
      ...
      if (_keymap == null) {
         ...
         if (_debug) {
            ...
            for (int i = 0; i < keys.length; ++i) {
               ...
               System.out.println(ks0.toString() + " : " +
                                  a0.getValue(Action.NAME));
            }
         }
      }
   ...
   void defineKeymap () {
      ...
      setActionForKeyStroke(KeyEvent.VK_N, InputEvent.CTRL_MASK,
                            new DownHistoryAction());
      setActionForKeyStroke(KeyEvent.VK_P, InputEvent.CTRL_MASK,
                            new UpHistoryAction());
      setActionForKeyStroke(KeyEvent.VK_F, InputEvent.CTRL_MASK,
                            new CaretMoveAction(1));
      setActionForKeyStroke(KeyEvent.VK_B, InputEvent.CTRL_MASK,
                            new CaretMoveAction( -1));
      setActionForKeyStroke(KeyEvent.VK_A, InputEvent.CTRL_MASK,
                            new CaretMoveAction( -2));
      setActionForKeyStroke(KeyEvent.VK_E, InputEvent.CTRL_MASK,
                            new CaretMoveAction(2));
      setActionForKeyStroke(KeyEvent.VK_D, InputEvent.CTRL_MASK,
                            new DeleteCharAction(1));
      setActionForKeyStroke(KeyEvent.VK_Y, InputEvent.CTRL_MASK,
                            new YankLineAction());
      setActionForKeyStroke(KeyEvent.VK_K, InputEvent.CTRL_MASK,
                            new KillLineAction(true, true));
      setActionForKeyStroke(KeyEvent.VK_X, InputEvent.CTRL_MASK,
                            DefaultEditorKit.cutAction);
      setActionForKeyStroke(KeyEvent.VK_C, InputEvent.CTRL_MASK,
                            DefaultEditorKit.copyAction);
      setActionForKeyStroke(KeyEvent.VK_V, InputEvent.CTRL_MASK,
                            new PasteAction(this));
      setActionForKeyStroke(KeyEvent.VK_W, InputEvent.CTRL_MASK,
                            new KillLineAction(false, true));
   ...
   public String completeNameFromLocalNameSpace (String name) {
      ...
      while (++_localNameSpaceCompletionIndex < keys.__len__()) {
         PyString key = (PyString) keys.__getitem__(
               _localNameSpaceCompletionIndex);
   ...
   public void completeInput () {
      ...
      try {
         if (_completionBuffer == null) {
            ...
            _completionBuffer = _document.getText(offset + 1,
                                                  _completionCursorOffset -
                                                  offset);
         ...
         while (_completionIndex++ < history_size) {
            ...
            System.out.println(" complete Input test(" + h_index + "): " +
                               hstr);
   ...
   public void killLine (boolean addToKillRing, boolean removeText) {
      ActionEvent ae0 = new ActionEvent(_textpane,
      ...
      if (removeText) {
         ActionEvent ae1 = new ActionEvent(_textpane,
                                           ActionEvent.ACTION_PERFORMED,
                                           "cut");
   ...
   public PyObject compile (java.io.InputStream s, String name) {
      // TODO return Py.compile(s, name, "exec");
      return null;
   ...
   {
      int _dir;
      public CaretMoveAction (int dir) {
         _dir = dir; }
   ...
   {
      int _dir;
      public DeleteCharAction (int dir) {
         _dir = dir; }
         ...
         extends AbstractAction
   {
      ...
      public KillLineAction (boolean addToKillRing, boolean removeText) {
         _addToKillRing = addToKillRing;
         _removeText = removeText;
      }


      public void actionPerformed (ActionEvent e) {
         killLine(_addToKillRing, _removeText); }
   }
   ...
   public void runShell () {
      String banner = "SME Python Shell (SPyConsole)\n" +
            "Jython " + systemState.version + " on platform " +
   ...
   public void processArgs (String args[]) {
      ...
      PySystemState.initialize(System.getProperties(), _opts.properties,
                               _opts.argv);
   }
   ...
   public static void main (String args[]) {
      ...
      try {
         c.appFrame.setIconImage(
               (new ImageIcon(c.getClass().getResource(
                     "../icons/jythonConsole.gif"))).getImage());
      }
      catch (Exception ex) {}

      c.appFrame.addWindowListener(l);
      c.appFrame.getContentPane().add(c.getConsolePanel(),
                                      BorderLayout.CENTER);
