...
public class LightFieldViewActions extends JPanel implements ItemListener {
   ...
   protected static ImageIcon createNavigationIcon(String imageName) {
      ...
      java.net.URL imageURL = LightFieldViewActions.class.getResource(imgLocation);
      if (imageURL == null) {
   ...
   public JMenuBar createMenuBar() {
      ...
      Action[] actions = { leftAction, middleAction, rightAction, upAction, downAction };
   ...
   public void createToolBar() {
      ...
      toolBar.add(button);
      button = new JButton(upAction);
      if (button.getIcon() != null) {
         button.setText(""); //an icon-only button
      }
      toolBar.add(button);
      button = new JButton(downAction);
      if (button.getIcon() != null) {
         button.setText(""); //an icon-only button
      }
      toolBar.add(button);
   ...
   public void displayResult(String actionDescription, ActionEvent e) {
      String s =
         ("Action event detected: " + actionDescription + newline + "    Event source: "
         + e.getSource() + newline);
      textArea.append(s);
   }
   ...
   public class DownAction extends AbstractAction {
      ...
      public void actionPerformed(ActionEvent e) {
         displayResult("Action for down", e);
      }
   }
...
//      LightFieldViewActions demo = new LightFieldViewActions();
//      frame.setJMenuBar(demo.createMenuBar());
//      demo.createToolBar();
//      demo.setOpaque(true); //content panes must be opaque
//      frame.add(new PanelControlXY(new LFViewController()));
//      frame.add(demo);
//      //Display the window.
//      frame.pack();
