...
public class VariLCModel
        extends Model {
   // <editor-fold defaultstate="collapsed" desc="<<< Declarations >>>">
   // Min / Max

   static final String DEFAULT_PREFS_KEY = "variLC";
   Preferences prefs;
   ...
   static final double MINA_DEFAULT = 0.17;
   // --- maxA ---
   public static final String PROPERTYNAME_MAXA = "maxA";
   static final double MAXA_DEFAULT = 0.99;
   // --- minB ---
   public static final String PROPERTYNAME_MINB = "minB";
   static final double MINB_DEFAULT = 0.17;
   // --- maxB ---
   public static final String PROPERTYNAME_MAXB = "maxB";
   static final double MAXB_DEFAULT = 0.99;
   // --- extA ---
   ...
   static final double STABILITYLEVEL_DEFAULT = 5.0;
   // --- roiSize ---
...
//    static final String COMMPORT_DEFAULT = "COM10";
    ...
    */
   public VariLCModel(InstrumentController instrumentCtrl) throws Exception {
      this(instrumentCtrl, DEFAULT_PREFS_KEY);
   }

   public VariLCModel(InstrumentController instrumentCtrl, String key) throws Exception {
      initializePrefs(key);

      this.instrumentCtrl = instrumentCtrl;
      this.vlcCtrl = (VariLCController) instrumentCtrl.getController("variLC");
   ...
   public void initializePrefs(String key) {
      ...
      typePrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_TYPE, TYPE_DEFAULT);
      serialNumberPrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_SERIALNUMBER, SERIALNUMBER_DEFAULT);
      settleTimePrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_SETTLETIME, SETTLETIME_DEFAULT);
      definelatencyPrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_DEFINELATENCY, DEFINELATENCY_DEFAULT);
      wavelengthPrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_WAVELENGTH, WAVELENGTH_DEFAULT);
      swingPrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_SWING, SWING_DEFAULT);
      minAPrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_MINA, MINA_DEFAULT);
      maxAPrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_MAXA, MAXA_DEFAULT);
      minBPrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_MINB, MINB_DEFAULT);
      maxBPrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_MAXB, MAXB_DEFAULT);
      extinctAPrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_EXTINCTA, EXTINCTA_DEFAULT);
      extinctBPrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_EXTINCTB, EXTINCTB_DEFAULT);
      a0PrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_A0, A0_DEFAULT);
      b0PrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_B0, B0_DEFAULT);
      a1PrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_A1, A1_DEFAULT);
      b1PrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_B1, B1_DEFAULT);
      a2PrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_A2,
              A2_DEFAULT);
      b2PrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_B2,
              B2_DEFAULT);
      a3PrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_A3,
              A3_DEFAULT);
      b3PrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_B3,
              B3_DEFAULT);
      a4PrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_A4, A4_DEFAULT);
      b4PrefAdapter = new PreferencesAdapter(prefs, VariLCModel.PROPERTYNAME_B4, B4_DEFAULT);
      selectedSettingPrefAdapter
              = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_SELECTEDSETTING, SELECTEDSETTING_DEFAULT);
      lastCalibratedPrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_LASTCALIBRATED, LASTCALIBRATED_DEFAULT);
      toleranceGrossPrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_TOLERANCEGROSS, TOLERANCEGROSS_DEFAULT);
      toleranceFinePrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_TOLERANCEFINE, TOLERANCEFINE_DEFAULT);
      toleranceAPrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_TOLERANCEA, TOLERANCEA_DEFAULT);
      toleranceBPrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_TOLERANCEB, TOLERANCEB_DEFAULT);
      maxIterationsPrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_MAXITERATIONS, MAXITERATIONS_DEFAULT);
      roiSizePrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_ROISIZE, ROISIZE_DEFAULT);
      commandFormatPrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_COMMANDFORMAT, COMMANDFORMAT_DEFAULT);
      baudRatePrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_BAUDRATE, BAUDRATE_DEFAULT);
...
//                VariLCModel.PROPERTYNAME_COMMPORT, COMMPORT_DEFAULT);
      stabilityLevelPrefAdapter = new PreferencesAdapter(prefs,
              VariLCModel.PROPERTYNAME_STABILITYLEVEL, STABILITYLEVEL_DEFAULT);
   }
   ...
   public void setA0(double A0) {
      ...
      vlcCtrl.defineElementAndMeasure(0);
   ...
   public void setA1(double A1) {
      ...
      vlcCtrl.defineElementAndMeasure(1);
   ...
   public void setA2(double A2) {
      ...
      vlcCtrl.defineElementAndMeasure(2);
   ...
   public void setA3(double A3) {
      ...
      vlcCtrl.defineElementAndMeasure(3);
   ...
   public void setA4(double A4) {
      ...
      vlcCtrl.defineElementAndMeasure(4);
