...
public class MemoryMonitor extends JPanel {
    ...
    static boolean doControls = false;
...
//  static MemoryMonitor memMon;
    ...
    public class Surface extends JPanel implements Runnable {
        ...
        public void paint(Graphics g) {
            ...
            big.drawString(String.valueOf( (int) totalMemory / 1024) +
                    "K allocated  (max: " + String.valueOf( (int) maxMemory / 1024) + ")",
            ...
            if (pts == null) {
                ...
                pts[ptNum] = (int) (graphY + graphH * ( (maxMemory - (totalMemory -
    ...
    public static void openInJFrame() {
        MemoryMonitor memMonitor = new MemoryMonitor();
        JButton gcButton = new JButton();
        try{
            gcButton.setIcon(JifUtils.loadImageIcon("trash16grn.gif", MemoryMonitor.class));
        } catch(Exception ex) {}
        ...
        try {
            f.setIconImage(JifUtils.loadImageIcon("MemMon.gif", MemoryMonitor.class).getImage());
        } catch(Exception ex) {}
        f.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
        
        
        f.getContentPane().add(memMonitor , BorderLayout.CENTER);
        f.getContentPane().add(gcButton, BorderLayout.SOUTH);
        f.pack();
    ...
    public static void gcButton_actionPerformed(ActionEvent e) {
        System.gc();
    }
