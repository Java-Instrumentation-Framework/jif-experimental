...
public class AcqModelPS extends Model {

  static final String DEFAULT_PREFS_KEY = "acqPS";
  Preferences prefs;
  // --- depth ---
  ...
  /** constructor
   */
  public AcqModelPS(InstrumentController instCtrl) throws Exception {
    this(instCtrl, DEFAULT_PREFS_KEY);
  }

  public AcqModelPS(InstrumentController instCtrl, String key) throws Exception {
  ...
  public void initializePreferenceAdapters(String key) {
    ...
    depthPrefAdapter =
            new PreferencesAdapter(prefs, AcqModelPS.PROPERTYNAME_DEPTH, DEPTH_DEFAULT);
    mirrorImagePrefAdapter =
            new PreferencesAdapter(prefs, AcqModelPS.PROPERTYNAME_MIRRORIMAGE, MIRRORIMAGE_DEFAULT);
    flipImagePrefAdapter =
            new PreferencesAdapter(prefs, AcqModelPS.PROPERTYNAME_FLIPIMAGE, FLIPIMAGE_DEFAULT);
    multiFramePrefAdapter =
            new PreferencesAdapter(prefs, AcqModelPS.PROPERTYNAME_MULTIFRAME, MULTIFRAME_DEFAULT);
    multiFrameBkgdPrefAdapter =
            new PreferencesAdapter(prefs, AcqModelPS.PROPERTYNAME_MULTIFRAMEBKGD, MULTIFRAMEBKGD_DEFAULT);
    divPrefAdapter =
            new PreferencesAdapter(prefs, AcqModelPS.PROPERTYNAME_DIV, DIV_DEFAULT);
    imagesInSequencePrefAdapter =
            new PreferencesAdapter(prefs, AcqModelPS.PROPERTYNAME_IMAGESINSEQUENCE, IMAGESINSEQUENCE_DEFAULT);
    intervalPrefAdapter =
            new PreferencesAdapter(prefs, AcqModelPS.PROPERTYNAME_INTERVAL, INTERVAL_DEFAULT);
    initDelayPrefAdapter =
            new PreferencesAdapter(prefs, AcqModelPS.PROPERTYNAME_INITDELAY, INITDELAY_DEFAULT);
    flushFirstFramePrefAdapter =
            new PreferencesAdapter(prefs, AcqModelPS.PROPERTYNAME_FLUSHFIRSTFRAME, FLUSHFIRSTFRAME_DEFAULT);
  }
  ...
  public static class AcqPresentation extends PresentationModel {
     ...
     */
    public AcqPresentation(AcqModelPS acqModel) {
      super(acqModel);

      // --- depth
      selectionInDepthList = new SelectionInList(acqModel.getDepthListModel(),
              getModel(AcqModelPS.PROPERTYNAME_DEPTH));
    }
