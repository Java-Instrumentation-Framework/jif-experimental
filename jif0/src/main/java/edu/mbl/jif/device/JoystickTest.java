...
//import edu.mbl.jif.joystick.DIAxisTransform;
//import edu.mbl.jif.joystick.DIDevice;
//import edu.mbl.jif.joystick.HiresClock;
//import edu.mbl.jif.joystick.NuLooqForm;
//import edu.mbl.jif.joystick.StringExt;
//import edu.mbl.jif.joystick.XYPositionPanel;
//import edu.mbl.jif.joystick.AxisListener;
...
//extends FrameForTest implements Runnable {
//
...
//
//    // DIInputs
//    // May want to use JXInputEventManager
//    public JoystickTest(String[] args) {
//
//        super();
...
////        if (deviceIndex >= n) {
////            System.out.println("Device index " + deviceIndex + " is out of range.");
...
//        for (int i = 0; i < na; i++) {
//            if (device.getAxis(i) != null) {
//                axisPanels[i] = new AxisPanel(device.getAxis(i));
//                String aName = device.getAxis(i).getName();
//                if (device.getAxis(i).getName().equalsIgnoreCase("X Axis")) {
//                    xAxisListener = new AxisListener(device.getAxis(i));
//                }
//                if (device.getAxis(i).getName().equalsIgnoreCase("Y Axis")) {
//                    yAxisListener = new AxisListener(device.getAxis(i));
//                }
//                if (device.getAxis(i).getName().equalsIgnoreCase("Z Rotation")) {
//                    zAxisListener = new AxisListener(device.getAxis(i));
//                }
//                p1.add(axisPanels[i]);
//            }
//        }
...
//        for (int i = 0; i < nd; i++) {
//            directionalPanels[i] = new DirectionalPanel(device.getDirectional(i));
...
//
//        XYPositionPanel xyp = new XYPositionPanel();
//        NuLooqForm nulq = new NuLooqForm(xyp);
//
//        if (xAxisListener != null) {
//            xAxisListener.addListener(nulq);
//        }
//        if (yAxisListener != null) {
//            yAxisListener.addListener(nulq);
//        }
//        if (zAxisListener != null) {
//            zAxisListener.addListener(nulq);
//        }
//        add(nulq, BorderLayout.SOUTH);
//
...
//
//            axis = a;
//            axisTransform = useSpaceWareAxisTransform ? new SpaceWareAxisTransform() : new DefaultAxisTransform();
//
...
//            add(deltaValueText);
//            accumValueText = new TextField(10);
//            add(accumValueText);
//            maxValue = 0.0;
...
//            accumValueText.setText(axf.format(accumValue));
//            repaint();
//            if (deltaValue > 100000.0 || deltaValue < -100000) {
//                System.out.println(axis.getName() + ":");
//                System.out.println("  " + lastValue + "  [" + int16(lastValue) + "] [" + int32(
//                    lastValue) + "]  " + bin(lastValue));
//                System.out.println("  " + currentValue + "  [" + int16(currentValue) + "] [" + int32(
...
//            if (axis.getName().equalsIgnoreCase("Z Axis")) {
//                //System.out.println(": " + deltaValue);
//            }
//        }
//
...
//
//        public void update() {
//            valueText.setText(dir.isCentered() ? "" : String.valueOf(dir.getDirection()));
//            repaint();
//        }
//
//    }
//    /** Polls the DirectInput device for data. */
//    int updatePeriod = 10; // msecs
//
//    public void run() {
//        while (true) {
//            update();
//            HiresClock.delay(updatePeriod);
//        }
//    }
// <editor-fold defaultstate="collapsed" desc=">>>--- Main / Test ---<<<" >
...
//        System.out.println(this.getClass().getName() + ": Watch DirectInput device data");
...
//        //PropsWassup.outputProperties(false);
//        JoystickTest jTest = new JoystickTest(args);
//
//        jTest.run();
//    }
// </editor-fold>
