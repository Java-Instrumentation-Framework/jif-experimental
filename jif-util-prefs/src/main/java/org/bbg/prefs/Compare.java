...
public class Compare extends JPanel implements ActionListener {
	...
	private Viewer	view, srcView, tgtView;
	...
	private static Compare self = null;		// singleton
	
	private Compare (JPanel owner) {
	...
	private void open (Viewer srcView, Viewer tgtView, TNode source, TNode target) {
	...
	static void start(Viewer srcView, Viewer tgtView, TNode source, TNode target) {
