...
public class PrefsEditor extends JFrame {

	final static String version = "0.8";
	final static String fileExt = ".preferences";
	static Icon blankIcon = new Main.BlankIcon();
	static Icon copyIcon = new ImageIcon(PrefsEditor.class.getResource("images/copy_edit.gif"));
	static Icon cutIcon = new ImageIcon(PrefsEditor.class.getResource("images/cut_edit.gif"));
	static Icon pasteIcon = new ImageIcon(PrefsEditor.class.getResource("images/paste_edit.gif"));
	static Icon delIcon = new ImageIcon(PrefsEditor.class.getResource("images/delete_edit.gif"));
	static Icon editIcon = new ImageIcon(PrefsEditor.class.getResource("images/text_edit.gif"));
	static Icon addIcon = new ImageIcon(PrefsEditor.class.getResource("images/add_exc.gif"));
	static Icon findIcon = new ImageIcon(PrefsEditor.class.getResource("images/search.gif"));
	static Icon nextIcon = new ImageIcon(PrefsEditor.class.getResource("images/search_next.gif"));
	static Icon refrIcon = new ImageIcon(PrefsEditor.class.getResource("images/refresh.gif"));
	static Icon helpIcon = new ImageIcon(PrefsEditor.class.getResource("images/help_topic.gif"));
	static Icon aboutIcon = new ImageIcon(PrefsEditor.class.getResource("images/help.gif"));
	static Icon fileIcon = new ImageIcon(PrefsEditor.class.getResource("images/file_obj.gif"));
	static Icon closeIcon = new ImageIcon(PrefsEditor.class.getResource("images/close_view.gif"));
	static Icon prevIcon = new ImageIcon(PrefsEditor.class.getResource("images/prev_nav.gif"));
	static Icon runIcon = new ImageIcon(PrefsEditor.class.getResource("images/run_exc.gif"));
	static Icon printIcon = new ImageIcon(PrefsEditor.class.getResource("images/export_log.gif"));
	static Icon expandIcon = new ImageIcon(PrefsEditor.class.getResource("images/expandall.gif"));
	static Icon collapIcon = new ImageIcon(PrefsEditor.class.getResource("images/collapseall.gif"));
	static ImageIcon logoIcon = new ImageIcon(PrefsEditor.class.getResource("images/javalogo1.gif"));
	static ImageIcon appIcon = new ImageIcon(PrefsEditor.class.getResource("images/appicon16.png"));
	static ImageIcon appLogo = new ImageIcon(PrefsEditor.class.getResource("images/javaprefs64c.png"));
	...
	private Action fileNewAction = new AbstractAction("New",
			new ImageIcon(PrefsEditor.class.getResource("images/new_con.gif"))) {
	...
	private Action fileOpenAction = new AbstractAction("Open",
			new ImageIcon(PrefsEditor.class.getResource("images/opentype.gif"))) {
	...
	private Action fileSaveAction = new AbstractAction("Save",
			new ImageIcon(PrefsEditor.class.getResource("images/save_edit.gif"))) {
	...
	private Main.FileChooser fileChooser = null;
	private Main.FileChooser htmlChooser = null;
	private PrefsEditorViewer user, sys;
	protected List<PrefsEditorViewer> viewers = new ArrayList<PrefsEditorViewer>();
	static PrefsEditorSearch search;
	static Preferences prefs = Preferences.userNodeForPackage(PrefsEditor.class);
	static Logger logger = Logger.getLogger("global");

	public PrefsEditor(Preferences startNodeUsr, Preferences startNodeSys) {
		// UI preferences
		...
		setTitle("Preferences: " + startNodeUsr.absolutePath());
		//
		...
		search = new PrefsEditorSearch(this);
		...
		try {
			user = new PrefsEditorViewer(this, startNodeUsr, div1);
			//user = new PrefsEditorViewer(this, Preferences.userRoot(), div1);
			if (startNodeSys != null) {
				sys = new PrefsEditorViewer(this, startNodeSys, div2);
			}
			//sys = new PrefsEditorViewer(this, Preferences.systemRoot(), div2);
		...
		tabCloseItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				PrefsEditorViewer v = currViewer();
				if (mayExit(v)) {
					tabbedPane.remove(v);
					viewers.remove(v);
				}
		...
		//
		fileChooser = new Main.FileChooser();
		...
		//
		htmlChooser = new Main.FileChooser();
	...
	private PrefsEditorViewer findViewer(File file) {
		for (PrefsEditorViewer v : viewers) {
	...
	private void addTab(File file, int divloc) {
		try {
			...
			PrefsEditorViewer v = new PrefsEditorViewer(this, file, divloc);
			viewers.add(v);
			tabbedPane.add(v);
			nameTab(v);
	...
	private void nameTab(PrefsEditorViewer v) {
		File file = v.getFile();
	...
	protected void savePrefs() {
		try {
			if (!prefs.nodeExists("")) {
				...
				prefs = Preferences.userNodeForPackage(PrefsEditor.class);
			}
	...
	protected boolean mayExit(PrefsEditorViewer curr) {
		boolean dirty = false;
		List<PrefsEditorViewer> tabs = viewers;
		if (curr != null) {
			tabs = new ArrayList<PrefsEditorViewer>(1);
			tabs.add(curr);
		}
		for (PrefsEditorViewer v : viewers) {
			if (v.isDirty()) {
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				//new PrefsEditor(new Preferences()).setVisible(true);
			}
	 ...
	 * <code> -Dlogging=fine,/tmp/poll.log </code> substituting desired log level and optional output file name. If not
	 * specified, log goes to standard output.
	 */
