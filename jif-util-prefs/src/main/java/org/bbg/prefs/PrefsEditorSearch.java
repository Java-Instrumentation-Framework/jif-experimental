...
public class PrefsEditorSearch extends JDialog implements ActionListener, ItemListener {
    ...
    private PrefsEditorViewer view;
    ...
    public PrefsEditorSearch (Frame owner) {
    	super(owner, false);
        initComponents();
	...
	void reset (PrefsEditorViewer view, TNode start) {
		this.view = view;
