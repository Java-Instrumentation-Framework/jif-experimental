...
public class Viewer extends JPanel 
    ...
    private   static Viewer copyView = null;	// viewer owning copyRef
    
    public Viewer (Main main, Preferences pref, int divloc)
    ...
    public Viewer (Main main, File file, int divloc) 
    ...
    void startSearch() {
    	Main.search.reset(this, currNode == null ? root : currNode);
    }
    ...
    void compare() {
    	...
    	Compare.start(copyView, this, copyRef, currNode);
    	/*
