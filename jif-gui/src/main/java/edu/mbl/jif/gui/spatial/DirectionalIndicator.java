...
public class DirectionalIndicator 
    ...
    public void paintComponent(Graphics g1) {
        ...
        poly.addPoint((int)(r + dropShadowHeight
                + (needleLength * Math.sin(thePhysicalAngle))),
                (int)((r + dropShadowHeight)
                - (needleLength * Math.cos(thePhysicalAngle))));
        poly.addPoint((int)(r + dropShadowHeight
                + (needleWidth * Math.cos(thePhysicalAngle))),
                (int)(r + dropShadowHeight
                + (needleWidth * Math.sin(thePhysicalAngle))));
        poly.addPoint((int)((r + dropShadowHeight)
        - (needleWidth * Math.cos(thePhysicalAngle))),
                (int)((r + dropShadowHeight)
                - (needleWidth * Math.sin(thePhysicalAngle))));
