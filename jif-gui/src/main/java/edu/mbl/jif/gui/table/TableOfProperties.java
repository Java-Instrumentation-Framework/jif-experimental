...
public class TableOfProperties {
  ...
  public static void main(String args[]) {
    ...
    TableSorter2 sorter = new TableSorter2(model);

    JTable table = new JTable(sorter);
    TableHeaderSorter2.install(sorter, table);
...
class TableSorter2 extends TableMap2 implements TableModelListener {
...
class TableHeaderSorter2 extends MouseAdapter {

  private TableSorter2 sorter;

  private JTable table;

  private TableHeaderSorter2() {
  }

  public static void install(TableSorter2 sorter, JTable table) {
    TableHeaderSorter2 tableHeaderSorter = new TableHeaderSorter2();
...
class TableMap2 extends AbstractTableModel implements TableModelListener {
