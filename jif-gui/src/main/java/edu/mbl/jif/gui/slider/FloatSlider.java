...
public class FloatSlider
     ...
     */
    public FloatSlider(int orientation, double cur, int vis, double min, double max,
                       int res, boolean log) {
    ...
    protected int rangeValue(double dval) {
        ...
        int vis = super.getVisibleAmount(), min = super.getMinimum(),
            max = super.getMaximum();
        int ival = (int) Math.round(transformRange(isLogScale, minFloat, maxFloat, dval, false,
            min, max - vis));
    ...
    public void setFloatValue(double newcur) {
        ...
        curFloat = newcur;
        // update the view
        super.setValues(rangeValue(newcur), super.getVisibleAmount(), super.getMinimum(),
            super.getMaximum());
    }
    ...
    private static double transformRange(boolean isLog, double a, double b, double x,
        ...
        double t = (x - a) / (b - a);
        double X = IsLog ? gerp(A, B, t) : lerp(A, B, t);
        return X;
    }
    ...
    public static void main(String args[]) {
        ...
        final FloatSlider rslider =
            new FloatSlider(Scrollbar.HORIZONTAL, 100.1f, 0.0004f, 100000f, true);
        ...
        // to use JGoodies Binding
//
//        rslider.setModel(new BoundedRangeAdapter(
...
//                createStringConverter(floatModel, NumberFormat.getPercentInstance()));
        ...
        mainpanel.add(new Label(
            "Range: " + rslider.getFloatMinimum() + " -> " + rslider.getFloatMaximum()));
        mainpanel.add(rslider);
        mainpanel.add(curValue);
        frame.add(mainpanel);
        frame.setSize(new Dimension(400, 64));
