...
/**
 * Known Bug: When user close the window and there are modifications been made, window will close
 * even if user selects cancel.
 */
import java.awt.*;
import javax.swing.*;
...
/**
 * A simple text editor that supports Open, Create, Save, Copy/Cut/Paste, Word Count, Find, and
 * Replace operations.
 *
...
public class SimpleNotePad extends JFrame {
  ...
  /**
   * Add the listeners associated with each sub menus. Also adding the document listener for the
