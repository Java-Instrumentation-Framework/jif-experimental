...
package edu.mbl.jif.gui.bean;

/*
 * $Id: AbstractBeanX.java,v 1.3 2007/02/27 21:34:45 rbair Exp $
 *
...
// FROM: package org.jdesktop.beans;
...
/**
 * <p>A convenience class from which to extend all non-visual AbstractBeanXs. It
 ...
 * 
 * <p>A non-visual java bean is a Java class that conforms to the AbstractBeanX 
 ...
 * <pre><code>
 *  public class ABean extends AbstractBeanX {
 *    private String foo;
 *    
 ...
 * 
 * <p><code>AbstractBeanX</code> also supports {@link VetoablePropertyChange} events. 
 ...
 * @author rbair
 */
public abstract class AbstractBeanX {
    /**
    ...
    /** Creates a new instance of AbstractBeanX */
    protected AbstractBeanX() {
        pcs = new PropertyChangeSupport(this);
        vcs = new VetoableChangeSupport(this);
    }
    
    /** 
     * Creates a new instance of AbstractBeanX, using the supplied PropertyChangeSupport and
     * VetoableChangeSupport delegates. Neither of these may be null.
     */
    protected AbstractBeanX(PropertyChangeSupport pcs, VetoableChangeSupport vcs) {
        if (pcs == null) {
    ...
    public Object clone() throws CloneNotSupportedException {
        AbstractBeanX result = (AbstractBeanX) super.clone();
