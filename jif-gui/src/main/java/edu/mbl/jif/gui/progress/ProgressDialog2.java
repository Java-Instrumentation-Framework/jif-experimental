...
// ProgressDialog2
// $Id: ProgressDialog2.java,v 1.11 2003/06/21 18:39:07 axelwernicke Exp $
...
/**
 * ProgressDialog2 provides a progress bar within a dialog window and a cancel button to abort the action.
 * 
...
public class ProgressDialog2 extends javax.swing.JDialog {
    ...
    /**
     * Creates new form ProgressDialog2
     * 
     * @param worker
     ...
     */
    public ProgressDialog2(SwingWorker worker, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.worker = worker;
        initComponents();
    }
