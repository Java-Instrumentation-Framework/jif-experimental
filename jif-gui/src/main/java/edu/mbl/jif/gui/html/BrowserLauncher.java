...
public class BrowserLauncher
{
   ...
   private static boolean loadClasses () {
      switch (jvm) {
         case MRJ_2_0:
            try {
               Class aeTargetClass = Class.forName(
                     "com.apple.MacOS.AETarget");
               Class osUtilsClass = Class.forName(
               ...
               aeDescConstructor = aeDescClass.getDeclaredConstructor(new
                     Class[] {String.class});
      ...
      switch (jvm) {
         case MRJ_2_0:
            try {
               ...
               Object aeTarget = aeTargetConstructor.newInstance(new
                     Object[] {finderCreatorCode});
               Integer gurlType = (Integer) makeOSType.invoke(null,
                     new Object[] {GURL_EVENT});
               Object appleEvent = appleEventConstructor.newInstance(new
                     Object[] {gurlType, gurlType, aeTarget,
         ...
         case OTHER:
            ...
            try {
               ...
               if (exitCode != 0) { // if Netscape was not open
                  Runtime.getRuntime().exec(new String[] {(String)
                                            browser, url});
               }
            }
            catch (InterruptedException ie) {
   ...
   public static void main (String[] args) {
      try {
         openURL("http://www.mbl.edu");
         /** @todo add html test file */
      }
