...
public class MenuButtonColorPick extends MenuedButton {

   public ColoredIcon selectedColor;
   public JButton back;

   public MenuButtonColorPick() {
      this(Color.black);
   }

   public MenuButtonColorPick(Color color) {
      this(color, color.toString());
   }

   public MenuButtonColorPick(Color color, String toolTip) {
