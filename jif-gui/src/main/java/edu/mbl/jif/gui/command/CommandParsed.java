package edu.mbl.jif.gui.command;
 ...
 * and its arguments.
 **/
public class CommandParsed implements ActionListener {
    ...
    public CommandParsed(Object target, Method m) { this(target, m, nullargs); }
	...
	public static void main(String[] args) throws IOException {
	    ...
	    b1.addActionListener(CommandParsed.parse(label, "setText(\"tick\");"));
	    b2.addActionListener(CommandParsed.parse(label, "setText(\"tock\");"));
