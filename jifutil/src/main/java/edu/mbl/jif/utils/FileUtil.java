   ...
   public static void fileCopy(String source_name,
      ...
      try {
         ...
         if (!source_file.canRead()) {
            throw new FileCopyException("FileCopy:sourcefile" + "is unreadable:" + source_name);
         }
   ...
   public static String chooseFileSave(String title, Component parent,
      ...
      if (dirName != null) {
         try {
            ...
            System.out.println("isDir: " + f.isDirectory() + "  path: " + f.getCanonicalPath()
...
//    }
   ...
   public static String removeTrailingNewlines(String line) {
      ...
      while ((cutoffPoint > 0) && ((line.charAt(cutoffPoint - 1) == 10) || (line.charAt(cutoffPoint
              - 1) == 13))) {
         cutoffPoint--;
      }
...
//    }
    ...
    * @param aAppend If true append to the end of the file. If false, overwrite the file.
    * @param aNewLine A flag to indicate if an End Of Line marker should be added at the end of the
    * file.
    */
    ...
    */
   public static void write(String aFileName, String aValue, boolean aAppend)
           throws IOException {
    ...
    * @see #write(String aFileName, String aValue, boolean aAppend, boolean aNewLine)
    */
   public static void writeln(String aFileName, String aValue, boolean aAppend)
           throws IOException {
    ...
    * @see #write(String aFileName, String aValue, boolean aAppend, boolean aNewLine)
    */
   public static void writeln(String aFileName, String aValue)
           throws IOException {
    ...
    */
   public static byte[] readBinary(String aFileName)
           throws IOException {
      File f = new File(aFileName);
   ...
   /**
    * Extract the extension from the file name, e.g. from pic1.jpg return jpg. Return empty string
    * if none found.
    */
   ...
   // requires jdk >= 1.4
   /**
    * Requires jdk >= 1.4 List the files and directories at a given path.
    *
    * @param aPath The starting path
    * @param aIncludeFiles Include files in the listing.
    * @param aIncludeDirs Include directories in the listing.
   ...
   /**
    * Create the complete directory structure for a complete FOLDER pathname.
    */
   ...
   /**
    * Create the complete directory structure for a complete FILE pathname.
    */
   ...
   public static boolean deleteFileOLD(String fileName) {
      ...
      if (!f.exists()) {
         throw new IllegalArgumentException("deleteFile: cannot delete, no such file or directory: "
                 + fileName);
      }
      if (!f.canWrite()) {
         throw new IllegalArgumentException("deleteFile: cannot delete - write protected: "
                 + fileName);
      }
   ...
   // --------------------------- Copy File -------------------------------------
   /**
    * Copies a file to another location/file Returns true if file copied or false if not (possibly
    * the file existed and 'overwrite' was not set).
    */
