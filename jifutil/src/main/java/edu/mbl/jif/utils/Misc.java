...
/**
  ...
  *
  * copyright (c) 1997-2003 Roedy Green, Canadian Mind Products
...
public class Misc
    ...
    * com.mindprod.inwords.BritishEnglish=British
    * com.mindprod.inwords.Dutch=Dutch
    * com.mindprod.inwords.Esperanto=Esperanto
    * com.mindprod.inwords.AmericanEnglish=North American  Vector
   ...
   /**
    * used to prepare SQL string literals by doubling each embedded '
    * and wrapping in ' at each end.
    * Further quoting is required to use the results
    * in Java String literals.
    * If you use PreparedStatement, then this method is not needed.
    * The ' quoting is automatically handled for you.
    *
   ...
   public static void main (String[] args)
      ...
      if ( false )
         {
         System.out.println(Misc.quoteSQL("Judy's Place"));
