...
public class Exec {
  ...
  public static void main(String[] args) {
    execPrint("cmd.exe /C " + "dir");
  }

//
//---------------------------------------------------------------------
/*
  public static void execWindows(String args[]) {
    try {
      ...
      // any error message?
     StreamGobbler3 errorGobbler = new StreamGobbler3(proc.getErrorStream(),
          "ERROR");

      // any output?
      StreamGobbler3 outputGobbler = new
          StreamGobbler3(proc.getInputStream(), "OUTPUT");
  ...
  class StreamGobbler3 extends Thread {
    InputStream is;
    String type;

    StreamGobbler3(InputStream _is, String _type) {
      is = _is;
      type = _type;
    }
