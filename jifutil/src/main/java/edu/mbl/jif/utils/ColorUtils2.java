 ...
 * MA  02111-1307, USA.
 */
// From :: package no.geosoft.cc.color.ui;
...
public class ColorUtils2
{
  ...
  {
    return ColorUtils2.blend (color1, color2, 0.5);
  }
  ...
  {
    return ColorUtils2.colorDistance (color1[0], color1[1], color1[2],
  ...
  public static double colorDistance (Color color1, Color color2)
  {
    ...
    return ColorUtils2.colorDistance (rgb1[0], rgb1[1], rgb1[2],
  ...
  public static boolean isDark (double r, double g, double b)
  {
    ...
    double dWhite = ColorUtils2.colorDistance (r, g, b, 1.0, 1.0, 1.0);
    double dBlack = ColorUtils2.colorDistance (r, g, b, 0.0, 0.0, 0.0);
