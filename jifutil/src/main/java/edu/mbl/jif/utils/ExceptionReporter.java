...
public class ExceptionReporter
{
   ...
   public static void main (String[] args) {
      ExceptionReporter.setPopupEnabled(true);
      // ...
      ExceptionReporter.reportException(new Throwable(new String("Yikes")), 
              ExceptionReporter.EXCEPTION_SEVERE, null, "discriptionOfActionOccuring");
   }
}
