...
public final class Condition_set
      implements Semaphore
{
   ...
   public boolean acquire_all (long timeout) throws
    ...
    * become true. If any of them are already true when this method is called,
   ...
   public synchronized boolean acquire_any (long timeout) throws
         InterruptedException,
         Semaphore.Timed_out {
      for (Iterator i = locks.iterator(); i.hasNext(); ) {
    ...
    *	is in progress.
    */
   private final class Lockable_condition
         extends Condition
   {
   ...
   public static final class Test
   {
      ...
      static Condition_set or_set = new Condition_set(
            Condition_set.ANY);
