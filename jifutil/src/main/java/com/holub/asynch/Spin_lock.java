...
import com.holub.asynch.Semaphore; // contains definition of timeout exception
...
public final class Spin_lock
{
   ...
   */
  public synchronized void acquire (Condition condition, long timeout) throws
      Semaphore.Timed_out,
  InterruptedException {
      long expiration = System.currentTimeMillis() +
      timeout; while (!condition.satisfied()) { //#here
