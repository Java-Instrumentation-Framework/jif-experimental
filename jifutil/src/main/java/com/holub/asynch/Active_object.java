...
public class Active_object
   ...
   *  waits for dispatch() requests, then executes them in
  ...
  /******************************************************************
   *  Request that the active object execute the execute()
  ...
  public final synchronized void dispatch(
      ...
      final Object argument) throws Blocking_queue.Closed {
   ...
   * the pending requests are handled by sending the Active_object
   * object a join() message:
   *		Active_object dispatcher = new Active_object();
   *		//...
