...
public final class Counting_semaphore implements Semaphore {
     ...
     *  @see release
     */
    public Counting_semaphore(int initial_count, int maximum_slots, boolean enforce_ownership,
    ...
    private final class Owner_list {
        ...
        public void remove_slots_for_current_thread(int number_of_slots)
            ...
            if (current == null) { // all slots associated with thread,  have been freed or thread never
