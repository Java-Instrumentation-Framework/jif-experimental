...
public class Generic_command
   ...
   * arbitrary Java method. Calling run invokes the
   *			method with the arguments passed to the Generic_command-object's
   *			constructor.
   * @param	receiver The receiver of the message: x
   *			in x.f(a,b). This argument can be
   *			this if you want to call a local method.
   * @param	method A string holding the name of a public method
   *			of the class of the receiver object.
   *			"f" for x.f(a,b).
  ...
  public Generic_command(Object receiver,
                         String method, Object[] arguments) throws
      NoSuchMethodException, SecurityException {
    this.receiver = receiver;
    this.arguments = (arguments == null) ? new Object[0]
        : arguments;

    Class[] types = (arguments == null) ? new Class[0]
        : classes(arguments);
    try {
  ...
  /**
   * Create an array of class objects, one for each element of
