...
import tests.swingworker.progressmonitor.SwingWorkerExecutor;
import javax.swing.*;
import java.awt.*;
import java.awt.event.*;
import java.util.ArrayList;

public class SwingWorkerProgressBarPrimes
        extends JFrame
   ...
   public SwingWorkerProgressBarPrimes() {
   ...
   public void actionPerformed(ActionEvent e) {
      if (e.getActionCommand().equalsIgnoreCase("Start")) {
         ...
         //swingWorker.execute(); // newinstance
   ...
   public static void main(String[] args) {
      ...
      SwingUtilities.invokeLater(new Runnable() {
         public void run() {
            new SwingWorkerProgressBarPrimes();
         }
      });
   }
}
