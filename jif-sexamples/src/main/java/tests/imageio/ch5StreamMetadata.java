...
public class ch5StreamMetadata extends IIOMetadata {
    static final String
        nativeMetadataFormatName = "ch5.imageio.ch5stream_1.00";
    static final String
        nativeMetadataFormatClassName = "ch5.imageio.ch5stream";
   ...
   /**
    ...
    private Node getNativeTree() {
        ...
        node.setAttribute("numberImages",
			  Integer.toString(numberImages));
