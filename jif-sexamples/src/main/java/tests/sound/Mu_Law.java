...
public class Mu_Law
    ...
    */
   public Mu_Law(byte[] b)
      {
      magic = new String(b, 0, 4);
      try
         {
         DataInputStream bis = new DataInputStream(new ByteArrayInputStream(b, 4, b.length-4));
      ...
      if ( debug ) System.out.println("magic <"+magic+"> dataLocation <"+dataLocation+"> dataSize <"+dataSize+"< dataFormat <"+dataFormat+"> samplingRate <"+samplingRate+"> channelCount <"+channelCount+"> info <"+info+">");
   ...
   /**
     ...
     */
   public Mu_Law(String info, short[] b)
      {
      this.info = info;
      dataSize = b.length;
