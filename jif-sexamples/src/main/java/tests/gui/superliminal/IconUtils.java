...
public class IconUtils {
	 ...
	 * @return URL version of name if a fully qualified url path otherwise a url relative to name with
	 * 'resources/' prepended and expected to be found in the classpath.
	 */
