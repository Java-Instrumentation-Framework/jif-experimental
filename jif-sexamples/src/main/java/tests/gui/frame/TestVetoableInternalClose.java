...
public class TestVetoableInternalClose extends JFrame {

	JDesktopPane desktopPane = new JDesktopPane();

	public TestVetoableInternalClose() {
	...
	public static void main(String args[]) {
		GJApp.launch(new TestVetoableInternalClose(),
...
class CloseListener implements VetoableChangeListener {
	...
	private TestVetoableInternalClose applet;
