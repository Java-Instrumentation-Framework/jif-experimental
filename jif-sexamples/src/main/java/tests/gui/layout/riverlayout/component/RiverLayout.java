package tests.gui.layout.riverlayout.component;
...
/**
 * <p>RiverLayout makes it very simple to construct user interfaces as components are laid out
 * similar to how text is added to a word processor (Components flow like a "river". RiverLayout is
 * however much more powerful than FlowLayout: Components added with the add() method generally gets
 * laid out horizontally, but one may add a string before the component being added to specify
 * "constraints" like this: add("br hfill", new JTextField("Your name here"); The code above forces
 * a "line break" and extends the added component horizontally. Without the "hfill" constraint, the
 ...
 *
 * @author David Ekholm
 * @version 1.1 (2005-05-23) -Bugfix: JScrollPanes were oversized (sized to their containing
 * component) if the container containing the JScrollPane was resized.
 */
