 ...
 * @author  rbair
 */
public class ActionDemoPanel extends JXPanel {
    ...
    public static void main(String args[]) {
       ...
       ActionDemoPanel ap = new ActionDemoPanel();
       f.add(ap);
       f.setVisible(true);
    }
...
//            }
    ...
    public ActionDemoPanel() {
        ...
        AcqCtrl acqCtrl = new AcqCtrl();
        manager.registerCallback("save", acqCtrl, "acqImage");
        ...
        manager.addAction(new AntiAliasAction("Anti-Alias", "aa", null)); //icon));
...
//        ((AbstractActionExt)manager.getAction("left-justify")).setStateAction(true);
        ...
        ((AbstractActionExt)manager.getAction("center-justify")).setStateAction(false);
...
//        menuPanel.setBorder(dsb);
        ...
        //manager.registerCallback( handler, "save")

        manager.setEnabled("print", false);
    }
    ...
    public class AcqCtrl {
      public void acqImage() {
         System.out.println("AcqImage...");
      }
   }
}
