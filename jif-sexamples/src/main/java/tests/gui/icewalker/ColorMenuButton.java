...
public class ColorMenuButton extends MenuedButton {
	...
	public ColorMenuButton(Color color) {
		this(color, color.toString());
	}
	
	public ColorMenuButton(Color color, String toolTip) {
		back = new JButton(null, new ColoredIcon(Color.black));
		back.setPreferredSize( new Dimension(22, 22) );				
		
		// TODO setMainButton(back);
		// TODO setPopupMenu( new ColorPanel(back) );
		setPopupLocation(MenuedButton.BELOW);
		setSelectedColor(color);
// TODO 		setToolTipText(toolTip);
	}
	
	public Color getSelectedColor() {
         return null;
		// TODO return ((ColoredIcon)getMainButton().getIcon()).getCurrentColor();
	}
