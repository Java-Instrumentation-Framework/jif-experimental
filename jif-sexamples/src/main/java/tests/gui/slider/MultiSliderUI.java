...
class MultiSliderUI extends MetalSliderUI {
    ...
    class MultiTrackListener extends BasicSliderUI.TrackListener {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            MultiSliderUI.this.currentIndex = findClosest(currentMouseX, currentMouseY, neighbours,
                -1);
        ...
        public void mouseDragged(MouseEvent e) {
            ((MultiSlider) MultiSliderUI.this.slider).setValueBeforeStateChange(((MultiSlider) MultiSliderUI.this.slider).getValueAt(
            ...
            switch (slider.getOrientation()) {
                case JSlider.VERTICAL:
                    ...
                    ((MultiSlider) slider).setValueAt(MultiSliderUI.this.currentIndex,
