package tests.beans.ContainerBean;
...
public class BeanContainer
    ...
    protected String m_className = "tests.ContainerBean.Clock";
    ...
    protected JMenuBar createMenuBar() {
        ...
        lst = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                getContentPane().setLayout(new GridLayout(row,
                        col,
                        10,
                        10));
                validate();
            ...
            try {
                ...
                for (int k = 0; k < m_numProps; k++) {
                    ...
                    if (mRead != null &&
                        ...
                        Object value = mRead.invoke(m_bean,
                                null);
